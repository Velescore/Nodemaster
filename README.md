# Nodemaster (Veles Core Release)

The **Nodemaster** scripts is a collection of utilities to manage, setup and update masternode instances.

The author is quite confident this is the single best and almost effortless way to setup different crypto masternodes, without bothering too much about the setup part.
...
**Install 6 Veles masternodes with the git release tag "tags/v0.17.0.21"**

```bash
./install.sh -p veles -c 6 -r "tags/v0.17.0.21"
```
